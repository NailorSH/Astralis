...
import com.nailorsh.astralis.core.utils.graphics.math.toMat4d
...
class Vector3<T : Number>(
    ...
    @Suppress("UNCHECKED_CAST")
    constructor(arr: FloatArray) : this(arr[0] as T, arr[1] as T, arr[2] as T)
...
//    }
    ...
    fun transfo4d(matrix: Mat4f) = transfo4d(matrix.toMat4d())
    ...
    companion object {
        fun getVectorAtIndex(i: Int, array: FloatArray): Vec3f {
            val offset = i * 3
            return Vec3f(array[offset], array[offset + 1], array[offset + 2])
        }
    }
}
